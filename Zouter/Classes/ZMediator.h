...
extern NSString * _Nonnull const kZMediatorParamsKeySwiftTargetModuleName;
extern NSString * _Nonnull const kZMediatorParamsKeyClassActionCalled;

@interface ZMediator : NSObject
